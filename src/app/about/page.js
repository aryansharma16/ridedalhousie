...
visible: (i) => ({ opacity: 1, x: 0, transition: { duration: 0.5, delay: i * 0.2, ease: "easeOut" } }),
};
...
<Head>
  ...
  {/* Hero Section */}
  <motion.section
    className={`relative h-96 flex items-center justify-center ${theme === 'dark' ? 'bg-gray-900' : 'bg-blue-50'}`}
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
