...
const metaTags = {
  ...
  description: "Reliable taxi services and travel guidance in Dalhousie and Himachal Pradesh. Book a cab with [Your Friend's Business Name] for local sightseeing and HP adventures.",
  ...
  googleReviews: "https://www.google.com/search?q=[yourfriendsbusiness]+reviews",
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content={`About Us - ${metaTags.businessName} Taxi Service`} />
        <meta property="og:description" content="Trusted taxi services in Dalhousie and HP with experienced drivers and scenic travel options." />
